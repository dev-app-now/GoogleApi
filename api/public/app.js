...
document.getElementById('addGmail').addEventListener('click', async () => {
    ...
    const scope = encodeURIComponent('https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/drive.file');
